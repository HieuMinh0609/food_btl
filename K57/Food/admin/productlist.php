...
<?php 
	...
	$conn = db_connect();
	$result = findPropertyProduct($conn,$arr,$offer,$limit);
	...
	printTable($result, 
		...
		"productedit.php","idproduct","productdelete.php","",null,"","");
 ...
 function prevPage()
{
    ...
    if (current_page > 1) {
        ...
        if("<?php echo  $nameCus ?>"==""){
        	window.location="productlist.php?page="+current_page;
        }else{

        	window.location="productlist.php?page="+current_page+"&nameCus="+"<?php echo  $nameCus ?>";
        } 
    }
