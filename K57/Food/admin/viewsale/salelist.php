...
<div class="container">
	<form action="salelist.php" method="get">
			<div class="row">
...
<div class="container">
	<a href="saleadd.php" class="btn btn-primary">Add</a>
...
<?php 
	...
	$conn = db_connect();
	$result = findPropertySale($conn,$arr,$offer,$limit);
	...
	printTable($result, 
		...
		"saleedit.php","idsale","saledelete.php","",null,"","");
 ...
 function prevPage()
{
    ...
    if (current_page > 1) {
        ...
        if("<?php echo  $nameCus ?>"==""){
        	window.location="salelist.php?page="+current_page;
        }else{

        	window.location="salelist.php?page="+current_page+"&nameCus="+"<?php echo  $nameCus ?>";
        } 
    }
