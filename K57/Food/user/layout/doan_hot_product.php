...
<div class="danhmuc">
	<span>Danh sách đồ ăn nóng</span>
	<a href="full-hotfood.php">Xem tất cả >>></a>
</div>
			<br>
			<hr>
			<div class="danhsach row">
				...
				<div class="p1 col-md-3">
					<div class="product">
						...
						<form action="" method="POST">						
							<img src="../image/<?php echo $dong['image']; ?>" alt=""><br>
							<?php $id_product= $dong['idproduct'];?>
							<a href="" class="product-name"><?php echo substr($dong['name'],0,30); ?></a><br>
							...
							<a href="layout.php?action=add3&id=<?php echo $id_product?>&promotion=<?php echo $promotion ?>" class="themgiohang">Thêm vào giỏ hàng</a>
				...
				<?php } 
					...
					if(isset($_GET['action']) && $_GET['action']=="add3"){
						if(getLoggedInUser() !=''){
